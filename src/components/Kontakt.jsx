      ...
      <Reveal className={styles.mapCard}>
        ...
        <div className={styles.map} role="img" aria-label="Mesto za mapu: lokacija salona u zgradi Sun City" data-placeholder="mapa">
          <svg className={styles.mapSvg} aria-hidden="true" viewBox="0 0 358 210" preserveAspectRatio="xMidYMid slice">
            <rect width="358" height="210" fill="#E8DBCC" />
            <rect x="18" y="20" width="96" height="62" rx="6" fill="#DFD0BF" />
            <rect x="140" y="14" width="80" height="72" rx="6" fill="#DFD0BF" />
            <rect x="246" y="22" width="96" height="58" rx="6" fill="#DFD0BF" />
            <rect x="18" y="126" width="110" height="70" rx="6" fill="#DFD0BF" />
            <rect x="232" y="128" width="110" height="68" rx="6" fill="#D6E0CB" />
            <path d="M0 104 H358" stroke="#FBF6F0" strokeWidth="16" />
            <path d="M128 0 V210" stroke="#FBF6F0" strokeWidth="10" />
            <path d="M232 0 L214 210" stroke="#FBF6F0" strokeWidth="8" />
            <text x="12" y="100" fontFamily="Manrope, sans-serif" fontSize="10" fontWeight="600" fill="#8A7461" letterSpacing="0.06em">JURIJA GAGARINA</text>
          </svg>
          <div className={styles.marker}>
            <span className={styles.markerLabel}>Sun City</span>
            <svg width="30" height="30" viewBox="0 0 24 24" fill="#A8764F" stroke="#2A1D15" strokeWidth="1.2" aria-hidden="true">
              <path d="M12 22s-7-6.2-7-11.5A7 7 0 0 1 19 10.5C19 15.8 12 22 12 22z" />
              <circle cx="12" cy="10.5" r="2.6" fill="#FBF6F0" />
            </svg>
          </div>
